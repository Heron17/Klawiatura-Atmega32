...
#define LCD_ROWS 4		// iloúÊ wierszy wyúwietlacza LCD
...
// ******** TYM RAZEM LINIE S• ZAKOMENTOWANE PONIEWAØ
// ******** MAKRA UØYTE S• W KILKU PLIKACH PROJEKTU
// ******** DLATEGO ZOSTA£Y PRZENIESIONE DO G£”WNEGO FOLDERU PROJEKTU
// ******** DO PLIKU "makra_mk.h"
//
...
void lcd_locate(int8_t y, int8_t x);				// domyúlnie W£•CZONA z kompilacji w pliku lcd.c
//zmiana 3 uint
